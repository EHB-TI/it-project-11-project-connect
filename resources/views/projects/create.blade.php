    ...
    <div>
        <form id="form_apply_markdown" action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-4">
            ...
            <fieldset>
                ...
                <input type="text" id="name" name="name" class="w-full lg:w-1/2 border border-gray-300 rounded-md px-3 py-2 mt-2 focus:outline-none focus:border-blue-500">
            </fieldset>
            <fieldset>
                <label for="brief" class="block font-semibold">Brief description:</label>
                <textarea id="brief" name="brief" rows="7" class="w-full lg:w-1/2 resize-none border border-gray-300 rounded-md px-3 py-2 mt-2 focus:outline-none focus:border-blue-500"> </textarea>
            </fieldset>
            ...
            <div class="mt-4 w-full">
                ...
                <input type="file" id="file" name="file" class="w-full lg:w-1/2 mt-1 py-2 px-4 border rounded-full border-gray-300">
            </div>
